...
public class MatArray {
	...
	private void createMatrix(int[] ch0, int[] ch1, int[] ch2, int[] ch3)
	{
		
		try
		{
			
			int[][] resultMat01 = new int[32768][32768];
			int[][] resultMat02 = new int[32768][32768];
			int[][] resultMat03 = new int[32768][32768];
			int[][] resultMat12 = new int[32768][32768];
			int[][] resultMat13 = new int[32768][32768];
			int[][] resultMat23 = new int[32768][32768];
		...
		{
			System.out.println("Error occured in createMatrix! " + e.getMessage());
		}
	}
